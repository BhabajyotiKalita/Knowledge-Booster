...
if(isset($_POST['submit'])){
	...
	if($email_count){
		...
		$SESSION['fname'] = $email_pass['fname'];
		...
		if($db_pass){
			?>
						<script> 
						alert("Redirected to the Main Page");
						window.location.replace("9usermainpage.php");
						</script>
...
<path width="100px" height="100px" viewBox="0 0 100 100" class="face" fill="#FBD7D7" d="M32,92.7H19.2v-7.5c0-11-0.1-17.2-11.1-23.3c-4.8,2.6-7.9,7.5-8.1,13c0,20.8,6.1,48.4,24.3,49.7l20.5,51.3
  ...
  <path fill="#FBD7D7" stroke="#000000" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="0.25" d="M250.7,117.4l25.5-30.9l-30.9-25.7L212,85.2L250.7,117.4z"/>
	...
	<div class="inputGroup inputGroup1">
		...
		<input type="text" name="email" id="email" class="email" maxlength="256" required="required"/>
		<span class="indicator"></span>
	</div>
	<div class="inputGroup inputGroup2">
		<label for="password">Password</label>
		<input type="password" name="pswd" id="password" class="password"  required="required"/>
	</div>
	<div class="inputGroup inputGroup3">
		<button type=""submit" name="submit" class="btn btn-primary btn-block" id="login">Log in</button>
	</div>
	<div class="forgot">
		<p><span class="frgttxt">Forgot Password? &nbsp; </span><a href="8forgotpassword.html" class="forget">Click Here!</a></p>
	</div>
</form>
